class FormValidator {
  ...
  constructor() {
    ...
    this.result = document.getElementById('result') as HTMLHeadingElement;
  ...
  helper(
    ...
    (elem.nextElementSibling as HTMLSpanElement).innerText = text;
    return result;
  }

  submission(e: SubmitEvent) {
    e.preventDefault();
  ...
  validateName(value: string) {
    if (
      ...
      return this.helper(
        this.name,
        'error',
        'Invalid name or string length more than 50 characters'
      );
    }
  }
